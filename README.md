...
<body>
  ...
  <div id="exam-container">
    ...
    <button id="startBtn" onclick="startExam()">بدء الامتحان</button>

    

    <!-- رسالة الإقصاء -->

    <p id="excludedMessage" style="color: red; display: none;">

      تم إقصاؤك من الامتحان بسبب الخروج أو تحديث الصفحة.

    </p>

    

    <!-- هنا ضع الأسئلة والعداد والنتيجة لاحقًا -->

    <div id="quizContent" style="display: none;">

      <!-- محتوى الامتحان سيظهر هنا عند البدء -->
...
function showQuestion() {
  ...
  <div id="exam-container">
    ...
    <p id="excludedMessage" style="color: red; display: none;">تم إقصاؤك من الامتحان بسبب الخروج من الصفحة.</p>

    <!-- بقية عناصر الامتحان هنا -->
  ...
  <script>
    ...
    // عند تحميل الصفحة: تحقق من حالة الإقصاء

    window.onload = function () {

      const wasExcluded = localStorage.getItem("excluded");
      ...
      if (wasExcluded === "true") {
        ...
        // يمكنك إخفاء باقي عناصر الامتحان هنا إذا لزم

      } else if (examStarted === "true") {

        // إذا بدأ الامتحان ولكن الصفحة أُعيد تحميلها ← إقصاء

        localStorage.setItem("excluded", "true");

        location.reload(); // لإعادة تحميل الصفحة وإظهار رسالة الإقصاء
    ...
    function startExam() {
      ...
      localStorage.setItem("excluded", "false");

      document.getElementById("startBtn").style.display = "none";

      // استدعاء دالة بدء الامتحان الفعلي مثل:
